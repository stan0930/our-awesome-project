...
INSERT INTO `campus_topic` VALUES (107, 2, 'hh', '/profile/upload/2025/09/22/微信图片_20230823145137_20250922144305A001.jpg', '0', '0', '', '2025-09-22 14:43:10', '', NULL, NULL, 'recommend');
INSERT INTO `campus_topic` VALUES (108, 2, '1', '/profile/upload/2025/09/22/微信图片_20230823145137_20250922145220A002.jpg', '0', '0', '', '2025-09-22 14:52:24', '', NULL, NULL, 'recommend');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2002 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 1, 'system', NULL, '', '', 1, 0, 'M', '0', '0', '', 'system', 'admin', '2025-09-21 20:04:51', '', NULL, '系统管理目录');
INSERT INTO `sys_menu` VALUES (2, '系统监控', 0, 2, 'monitor', NULL, '', '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', '2025-09-21 20:04:51', '', NULL, '系统监控目录');
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 3, 'tool', NULL, '', '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', '2025-09-21 20:04:51', '', NULL, '系统工具目录');
INSERT INTO `sys_menu` VALUES (4, '若依官网', 0, 4, 'http://ruoyi.vip', NULL, '', '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', '2025-09-21 20:04:51', '', NULL, '若依官网地址');
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', 1, 1, '0', '0', 'admin', '2025-09-21 20:04:51', 'admin', '2025-09-22 14:37:19', '普通角色');
